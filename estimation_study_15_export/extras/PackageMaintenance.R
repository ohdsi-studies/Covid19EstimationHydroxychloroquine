...
OhdsiRTools::checkUsagePackage("hcqExtraTAR")
OhdsiRTools::updateCopyrightYearFolder()
devtools::spell_check()

# Create manual -----------------------------------------------------------
shell("rm extras/hcqExtraTAR.pdf")
shell("R CMD Rd2pdf ./ --output=extras/hcqExtraTAR.pdf")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("hcqExtraTAR")
