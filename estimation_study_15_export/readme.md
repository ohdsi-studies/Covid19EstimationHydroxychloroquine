...
2. In `R`, use the following `devtools` command to install the hcqExtraTAR package:
...
License
=======
The hcqExtraTAR package is licensed under Apache License 2.0

Development
===========
hcqExtraTAR was developed in ATLAS and R Studio.
